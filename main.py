@namespace
class SpriteKind:
    Red = SpriteKind.create()

def on_player4_connected():
    music.play(music.string_playable("C5 G E A F G C5 B ", 252),
        music.PlaybackMode.UNTIL_DONE)
    Maps()
controller.player4.on_event(ControllerEvent.CONNECTED, on_player4_connected)

def Players():
    global mySprite, mySprite3, mySprite2, mySprite4
    ...
    mySprite2 = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    controller.player3.move_sprite(mySprite2)
    mySprite4 = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    game.show_long_text("Сбор участников", DialogLayout.BOTTOM)
    return 0
...
def on_countdown_end():
    music.play(music.string_playable("G F G A - F E D ", 120),
        music.PlaybackMode.UNTIL_DONE)
    game.show_long_text("Охотник уже ищет!", DialogLayout.BOTTOM)
    controller.player1.move_sprite(mySprite, 0, 0)
    controller.player2.move_sprite(mySprite2, 0, 0)
    controller.player3.move_sprite(mySprite3, 0, 0)
    controller.player4.move_sprite(mySprite4)
info.on_countdown_end(on_countdown_end)

def on_player4_button_a_pressed():
    game.show_long_text("Искатель вас нашёл 😭", DialogLayout.BOTTOM)
    game.set_game_over_message(False, "Игра окончена!")
...
def Maps():
    game.show_long_text("Выбор карты!", DialogLayout.BOTTOM)
    for index in range(randint(1, 998.5)):
        ...
        tiles.set_current_tilemap(tilemap("""
            level4
        """))
    game.show_long_text("Прятчесь!", DialogLayout.BOTTOM)
